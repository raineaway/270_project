	...
	<div class="container">
      <div class="page-header" style="margin-top: 40px">
		...
		<div id="body" style="width:50%">
            ...
            <?php
                if (isset($success)) {
                    echo '<div class="alert alert-info" role="alert" style="float:left; width:100%; display:block;">'
                        . $success . '</div>';
                }
                if (isset($fail)) {
                    echo '<div class="alert alert-danger" role="alert" style="float:left; width:100%; display:block;">'
                        . $fail . '</div>';
                }
            ?>
            </div>
